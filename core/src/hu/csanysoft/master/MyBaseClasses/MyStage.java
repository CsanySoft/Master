 ...
 */
abstract public class MyStage extends Stage implements hu.csanysoft.master.MyBaseClasses.InitableInterface {
    public final hu.csanysoft.master.MyGdxGame game;

    private float timer = 0;
    private boolean timerRunning = false;

    public MyStage(Viewport viewport, Batch batch, hu.csanysoft.master.MyGdxGame game) {
